...
interface AuthenticationRepository {
    ...
    suspend fun verify(input: SendCodeInput): Either<SendCodeError, SendCodeOutput>
    suspend fun confirm(input: ConfirmAccountInput): Either<ConfirmAccountError, ConfirmAccountOutput>
